<div class="container">
    <h1 class="text-center">Data Project</h1>
    ...
    <table class="table table-striped table-bordered">
        <thead>
            <tr>
                ...
                <th><p align="center">Project Code</p></th>
                <th><p align="center">Project Name</p></th>
                <th><p align="center">Project Type</p></th>
                <th><p align="center">Description</p></th>
                <th><p align="center">Estimation (month)</p></th>
                <th><p align="center">Project Reg. Date</p></th>
                <th><p align="center">BRD</p></th>
                <th><p align="center">FSD</p></th>
                <th><p align="center">TSD</p></th>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="upload-fsd" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                <h4 class="modal-title">Upload FSD</h4>
            </div>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="upload-tsd" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                <h4 class="modal-title">Upload TSD</h4>
            </div>
