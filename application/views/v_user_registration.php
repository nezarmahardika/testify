...
<body class="bg-dark">
    <div class="container">
        <div class="card mx-auto mt-5">
            <div class="card-header" align="middle">User Registration Form</div>
            <label>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker form-control" name="RoleID" title="--Choose one--">
                                ...
                                <div class="form-group" style="float:right;"></br></br>
                                    ...
                                    <a href="<?php echo site_url('Login/index') ?>"  role="button" class="btn btn-danger">Cancel</a>                                </div>
                                    <?php echo form_close(); ?>
