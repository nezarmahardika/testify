<div class="container">
		<h1 class="text-center">Data Project PT Lead</h1>
		...
		<table class="table table-striped table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php if (is_null($dt['FilePT']) == TRUE ) {
						echo "-";
					}else {
						echo "sudah";
					}?></td>
					<td>
    					...
    					data-NameFilePT="<?php echo $dt['NameFilePT'] ?>"
    					data-FilePT="<?php echo $dt['FilePT'] ?>"
							data-toggle="modal" data-target="#upload-pt" class="view-pt">
    					<button  data-toggle="modal" data-target="#pt" class="btn btn-info">Upload PT Report</button>
						</a>
					</td>
				</tr>
				<?php } ?>
	...
	<!-- Modal Upload BRD -->
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="upload-pt" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="upload-brdd" class="form-horizontal" action="<?php echo base_url().'index.php/c_ptlead/pt_upload'?>" method="post" enctype="multipart/form-data" role="form">
	            <div class="modal-body">
	                    <div class="form-group">
	                        <label class="col-lg-2 col-sm-2 control-label">File Name</label>
	                        <div class="col-lg-10">
	                        	<input type="hidden" id="ProjectID" name="ProjectID">
	                            <input type="text" class="form-control" id="NameFilePT" name="NameFilePT" placeholder="-- File Name --">
	                        </div>
	                    </div>
	                    <div class="form-group">
	                        <label class="col-lg-2 col-sm-2 control-label">File</label>
	                        <div class="col-lg-10">
	                            <input type="file" class="form-control" id="FilePT" name="FilePT">
	                        </div>
	                    </div>
	                </div>
